...
namespace Albian.Kernel.ThreadPool
{
    ...
    {
        private static Albian.Kernel.ThreadPool.ThreadPool pools;
        ...
        {
            pools = new Albian.Kernel.ThreadPool.ThreadPool();
            pools.Start();
        }
        ...
        {
            pools = new Albian.Kernel.ThreadPool.ThreadPool(size);
            pools.Start();
        ...
        {
            pools = new Albian.Kernel.ThreadPool.ThreadPool(isFlowExecutionContext);
            pools.Start();
        ...
        {
            pools = new Albian.Kernel.ThreadPool.ThreadPool(size, isFlowExecutionContext);
            pools.Start();
